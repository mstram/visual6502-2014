...
function setupBackground(){
	...
	console.log('wires.js:setupBackground grCanvasSize = ' + grCanvasSize);
	for(var i in segdefs){
		var seg = segdefs[i];
		var c = seg[2];
		if (drawlayers[c]) {
...
function hiliteNode(n){
	...
	hilited = n;
        ...
        // mike
        console.log('wires:hiliteNode n = ' + n);
	for(var i in n){
                // mike
               console.log('wires:hiliteNode i = ' + i);
...
function clearHighlight(){
	...
	console.log('wires.js:clearHighlight :: ctx.clearRect(0,0,grCanvasSize,grCanvasSize);');
	ctx.clearRect(0,0,grCanvasSize,grCanvasSize);
}
